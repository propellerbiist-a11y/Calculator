...
//document.getElementById finds an HTML element by its id. We save the result in const variables so we can reuse them.
//let = a variable we can change. currentInput stores what the user is typing (e.g. "12+5"). justCalculated is a flag that tracks whether = was just pressed.
